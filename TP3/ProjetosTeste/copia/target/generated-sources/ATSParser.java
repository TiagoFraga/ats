		...
		try {
			...
			case T__11:
				...
				match(PONTO_VIRGULA);
				           ...
				           if((((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null) ==null){
				              Helicopter heli = new Helicopter((((EventoContext)_localctx).matricula!=null?_input.getText(((EventoContext)_localctx).matricula.start,((EventoContext)_localctx).matricula.stop):null), (((EventoContext)_localctx).NUMERO!=null?Integer.valueOf(((EventoContext)_localctx).NUMERO.getText()):0), position, (((EventoContext)_localctx).MAIL!=null?((EventoContext)_localctx).MAIL.getText():null));
				              ...
				              Helicopter heli = new Helicopter((((EventoContext)_localctx).matricula!=null?_input.getText(((EventoContext)_localctx).matricula.start,((EventoContext)_localctx).matricula.stop):null), (((EventoContext)_localctx).NUMERO!=null?Integer.valueOf(((EventoContext)_localctx).NUMERO.getText()):0), position, (((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null)); 
				              bol = umer.registerCompanyVehicle((((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null),(Vehicle) heli);
			...
			case T__13:
				...
				match(PONTO_VIRGULA);
				           ...
				           Point2D.Double position = new Point2D.Double (x,y);
				           if((((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null) ==null){
				              Van van = new Van((((EventoContext)_localctx).matricula!=null?_input.getText(((EventoContext)_localctx).matricula.start,((EventoContext)_localctx).matricula.stop):null), (((EventoContext)_localctx).NUMERO!=null?Integer.valueOf(((EventoContext)_localctx).NUMERO.getText()):0), position, (((EventoContext)_localctx).MAIL!=null?((EventoContext)_localctx).MAIL.getText():null));
				              ...
				              Van van = new Van((((EventoContext)_localctx).matricula!=null?_input.getText(((EventoContext)_localctx).matricula.start,((EventoContext)_localctx).matricula.stop):null), (((EventoContext)_localctx).NUMERO!=null?Integer.valueOf(((EventoContext)_localctx).NUMERO.getText()):0), position, (((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null));
				              bol = umer.registerCompanyVehicle((((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null),(Vehicle) van);
			...
			case T__14:
				...
				match(PONTO_VIRGULA);
				           ...
				           Point2D.Double position = new Point2D.Double (x,y);
				           if((((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null) ==null){
				                Car car = new Car((((EventoContext)_localctx).matricula!=null?_input.getText(((EventoContext)_localctx).matricula.start,((EventoContext)_localctx).matricula.stop):null), (((EventoContext)_localctx).NUMERO!=null?Integer.valueOf(((EventoContext)_localctx).NUMERO.getText()):0), position, (((EventoContext)_localctx).MAIL!=null?((EventoContext)_localctx).MAIL.getText():null)); 
				                ...
				                Car car = new Car((((EventoContext)_localctx).matricula!=null?_input.getText(((EventoContext)_localctx).matricula.start,((EventoContext)_localctx).matricula.stop):null), (((EventoContext)_localctx).NUMERO!=null?Integer.valueOf(((EventoContext)_localctx).NUMERO.getText()):0), position, (((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null)); 
				                bol = umer.registerCompanyVehicle((((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null),(Vehicle) car);
			...
			case T__15:
				...
				match(PONTO_VIRGULA);
				           ...
				           Point2D.Double position = new Point2D.Double (x,y);
				           if((((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null) ==null){
				               Bike bike = new Bike((((EventoContext)_localctx).matricula!=null?_input.getText(((EventoContext)_localctx).matricula.start,((EventoContext)_localctx).matricula.stop):null), (((EventoContext)_localctx).NUMERO!=null?Integer.valueOf(((EventoContext)_localctx).NUMERO.getText()):0), position, (((EventoContext)_localctx).MAIL!=null?((EventoContext)_localctx).MAIL.getText():null));
				               ...
				               Bike bike = new Bike((((EventoContext)_localctx).matricula!=null?_input.getText(((EventoContext)_localctx).matricula.start,((EventoContext)_localctx).matricula.stop):null), (((EventoContext)_localctx).NUMERO!=null?Integer.valueOf(((EventoContext)_localctx).NUMERO.getText()):0), position, (((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null)); 
				               bol = umer.registerCompanyVehicle((((EventoContext)_localctx).empresa!=null?_input.getText(((EventoContext)_localctx).empresa.start,((EventoContext)_localctx).empresa.stop):null),(Vehicle) bike);
