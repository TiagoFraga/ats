...
evento : 'logout' PONTO_VIRGULA{
       ...
       | 'recusar viagem' PONTO_VIRGULA{
          ...
          //if (utilizador != null){
            //umer.cancelTripQueue(cliente.getEmail());
            //System.out.print("Viagem Recusada. ");
            //System.out.println("\n");
          //} 
          //else{
             //System.out.print("Não existe viagens. ");
             //System.out.println("\n");
          //}  
         }
       ...
       | 'login' '"' MAIL '"' '"' password '"' PONTO_VIRGULA{
          ...
          if(list.containsKey($MAIL.text)){
              ...
              System.out.println("LOGIN: "+ utilizador.getEmail() +" -> Sucesso! ");
              System.out.println("\n");
          }else{
       ...
       | 'registar condutor' '"' MAIL '"' '"' nome '"' '"' password '"' '"' morada '"' nascimento NUMERO ('"' empresa '"')? PONTO_VIRGULA{
          Boolean bol;
          DateTimeFormatter formatto = DateTimeFormatter.ofPattern("yyyy-M-d");
...
nascimento : NUMERO MENOS (NUMERO|DIGITO) MENOS (NUMERO|DIGITO) ;
