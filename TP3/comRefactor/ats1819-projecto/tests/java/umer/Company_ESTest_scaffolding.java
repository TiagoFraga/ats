...
public class Company_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("umer.Driver", false, Company_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("umer.Trip", false, Company_ESTest_scaffolding.class.getClassLoader()));
