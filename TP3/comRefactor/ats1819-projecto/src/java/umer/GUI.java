...
public class GUI extends Application{
    ...
    public boolean addVehicle(String licencePlate, String vehicleClass, String condition, Point2D.Double position){
        if (licencePlate != null && vehicleClass != null && condition != null && position != null &&
            ...
            if (this.current_class.equals("umer.Driver")) {
    ...
    public String printTime(double time){
        ...
        sb.append((int) time); sb.append("h:"); sb.append(Math.round(time * 60)%60);
        sb.append("m:"); sb.append(Math.round(time * 3600)%60); sb.append("s");
    ...
    public String printClient(Client client){
        ...
        sb.append("Nome: "); sb.append(client.getName());
        sb.append("\nEmail: "); sb.append(client.getEmail());
        sb.append("\nMorada: "); sb.append(client.getAddress()); 
        sb.append("\nData de nascimento: "); sb.append(client.getBirthday()); 
        sb.append("\nViagens totais: "); sb.append(client.getNumberOfTrips()); 

        sb.append("\nDistância percorrida: "); sb.append(printDistance(client.getTotalDistance()));
        sb.append("\nDinheiro gasto: "); sb.append(printMoney(client.getMoney()));
        sb.append("\nPontos: "); sb.append((int) client.getPoints()); 

        return sb.toString();
    }

    public String printDriver(Driver driver){
        StringBuilder sb = new StringBuilder();

        sb.append("Nome: "); sb.append(driver.getName());
        sb.append("\nEmail: "); sb.append(driver.getEmail());
        sb.append("\nMorada: "); sb.append(driver.getAddress()); 
        sb.append("\nData de nascimento: "); sb.append(driver.getBirthday()); 
        sb.append("\nViagens totais: "); sb.append(driver.getNumberOfTrips()); 
        sb.append("\nDistância percorrida: "); sb.append(printDistance(driver.getTotalDistance()));
        sb.append("\nDinheiro ganho: "); sb.append(printMoney(driver.getMoney()));
        sb.append("\nNúmero de classificações: "); sb.append(driver.getNumberOfReviews());
        sb.append("\nClassficação: "); sb.append(Math.round(driver.getRating()));
        sb.append("\nExperiência: "); sb.append(driver.getExp());
        sb.append("\nDesvio total: "); sb.append(printMoney(driver.getDeviation()));
        sb.append("\nVeículo: "); sb.append(driver.getVehicle());
        sb.append("\nEmpresa: "); sb.append(driver.getCompany());
    ...
    public String printCompany(Company company){
        ...
        sb.append("Nome: "); sb.append(company.getName());
        sb.append("\nNúmero de condutores: "); sb.append(company.getDrivers().size());
        sb.append("\nNúmero de veículos: "); sb.append(company.getVehicles().size()); 
        sb.append("\nNúmero de viagens: "); sb.append(company.getTotalTrips()); 
        sb.append("\nDinheiro gerado: "); sb.append(printMoney(company.getMoneyGenerated())); 

        return sb.toString();
    }

    public String printVehicle(Vehicle veiculo){
        StringBuilder sb = new StringBuilder();

        sb.append("Matrícula: "); sb.append(veiculo.getLicencePlate());
        sb.append("\nClass: "); sb.append(veiculo.getClass().getSimpleName());
        sb.append("\nVelocidade: "); sb.append(veiculo.getSpeed()); sb.append(" km/s");
        sb.append("\nPreço (por km): "); sb.append(veiculo.getPrice()); sb.append("€");
        sb.append("\nLugares: "); sb.append(veiculo.getSeats());
        sb.append("\nFator de confiança: "); sb.append((int) veiculo.getReliable());
        sb.append("\nPosição Atual: "); sb.append(veiculo.getPosition().getX()); sb.append(" , ");  sb.append(veiculo.getPosition().getY());
        sb.append("\nNúmero de viagens: "); sb.append(veiculo.getTrips().size());
        sb.append("\nDono: "); sb.append(veiculo.getOwner());
    ...
    public String printAdminInfo(){
        ...
        sb.append("Número de viagens : "); sb.append(umer.getTrips().size());
        sb.append("\nNúmero de condutores : "); sb.append(umer.getAllDrivers().size());
        sb.append("\nNúmero de veículos : "); sb.append(umer.getAllVehicles().size());
        sb.append("\nNúmero de empresas : "); sb.append(umer.getCompanies().size());
        sb.append("\nNúmero de clientes : "); sb.append(umer.getClients().size());
        sb.append("\nDinheiro gerado : "); sb.append(printMoney(umer.getMoneyGenerated()));
        sb.append("\nDistância total : "); sb.append(printDistance(umer.getTotalDistance()));
        sb.append("\nTempo total : "); sb.append(printTime(umer.getTotalTime()));
    ...
    public void driverSignupMenu(){
        ...
        signupDone_button.setOnAction(e -> {
            ...
            if (!b) {
                ...
                this.current_class = "umer.Driver";
    ...
    public void vehicleSignupMenu(){
        ...
        signupDone_button.setOnAction(e ->{
            try{
                ...
                else if (current_class.equals("umer.Driver")) {
    ...
    public void loginMenu(){
        ...
        login_button.setOnAction(e -> {
            ...
            else if (current_class.equals("umer.Client")) {
                clientMenu();
                window.setScene(user_menu);
            }
            else if (current_class.equals("umer.Driver")) {
            ...
            else if (current_class.equals("umer.Company")){
                companyMenu();
                window.setScene(user_menu);
            }
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        this.window.setTitle("umer.UMeR");
