...
public class Bike extends Vehicle implements Serializable {
     ...
     * @param v Mota
     */
    public Bike(Bike mota) {
        super(mota.getLicencePlate(), mota.getReliable(), mota.getPosition(), mota.isAvailable(), mota.getQueue(), mota.getQueueInfo(), mota.getTrips(), mota.getOwner());
        this.setSpeed(75);
        this.setPrice(0.9);
        this.setSeats(1);
    }
