...
public class Car extends Vehicle implements Serializable {
     ...
     * @param v Carro
     */
    public Car(Car carro) {
        super(carro.getLicencePlate(), carro.getReliable(), carro.getPosition(), carro.isAvailable(), carro.getQueue(), carro.getQueueInfo(), carro.getTrips(), carro.getOwner());
        this.setSpeed(65);
        this.setPrice(1.5);
        this.setSeats(4);
    }
